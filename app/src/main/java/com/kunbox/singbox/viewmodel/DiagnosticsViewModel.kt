...
import com.kunbox.singbox.repository.ConfigRepository.ConfigGenerationResult
import com.kunbox.singbox.service.SingBoxService
import com.kunbox.singbox.utils.TcpPing
        ...
        viewModelScope.launch {
            ...
            try {
                ...
                val report = withContext(Dispatchers.IO) {
                    ...
                    val coreActive = com.kunbox.singbox.ipc.VpnStateStore.getActive()
