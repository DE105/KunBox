...
import com.kunbox.singbox.model.EchConfig
import com.kunbox.singbox.model.MultiplexConfig
import com.kunbox.singbox.model.ObfsConfig
import com.kunbox.singbox.model.Outbound
import com.kunbox.singbox.model.TlsConfig
import com.kunbox.singbox.model.TransportConfig
import com.kunbox.singbox.model.UdpOverTcpConfig
import com.kunbox.singbox.model.WireGuardPeer
import com.kunbox.singbox.repository.ConfigRepository
import com.kunbox.singbox.ui.components.EditableSelectionItem
import com.kunbox.singbox.ui.components.EditableTextItem
import com.kunbox.singbox.ui.components.SelectProfileDialog
import com.kunbox.singbox.ui.components.SelectProfileTarget
                    ...
                    StandardCard {
                            ...
                            EditableSelectionItem(
                                ...
                                onValueChange = { type ->
                                    val newTls = when (type) {
                                        ...
                                        "reality" -> tls.copy(enabled = true, reality = com.kunbox.singbox.model.RealityConfig(enabled = true))
                                        else -> tls
                                    }
                        ...
                        if (securityType != "none") {
                            ...
                            EditableSelectionItem(
                                ...
                                icon = Icons.Rounded.Fingerprint,
                                onValueChange = { fp ->
                                    val newUtls = if (fp.isEmpty()) null else com.kunbox.singbox.model.UtlsConfig(enabled = true, fingerprint = fp)
                            ...
                            if (securityType == "reality") {
                                val reality = tls.reality ?: com.kunbox.singbox.model.RealityConfig(enabled = true)
                                Spacer(modifier = Modifier.height(8.dp))
                                EditableTextItem(
