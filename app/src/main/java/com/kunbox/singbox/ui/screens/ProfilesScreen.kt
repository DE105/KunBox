...
import com.kunbox.singbox.model.UpdateStatus
import com.kunbox.singbox.ui.scanner.QrScannerActivity
import com.kunbox.singbox.ui.components.InputDialog
import com.kunbox.singbox.ui.components.ProfileCard
import com.kunbox.singbox.ui.components.StandardCard
import com.kunbox.singbox.ui.navigation.Screen
import com.kunbox.singbox.utils.DeepLinkHandler
...
fun ProfilesScreen(
    ...
    viewModel: com.kunbox.singbox.viewmodel.ProfilesViewModel = androidx.lifecycle.viewmodel.compose.viewModel()
) {
    ...
    var editingProfile by remember { mutableStateOf<com.kunbox.singbox.model.ProfileUi?>(null) }
    ...
    androidx.compose.runtime.LaunchedEffect(importState) {
        when (val state = importState) {
            is com.kunbox.singbox.viewmodel.ProfilesViewModel.ImportState.Success -> {
            ...
            is com.kunbox.singbox.viewmodel.ProfilesViewModel.ImportState.Error -> {
    ...
    if (importState is com.kunbox.singbox.viewmodel.ProfilesViewModel.ImportState.Loading) {
        ImportLoadingDialog(
            message = (importState as com.kunbox.singbox.viewmodel.ProfilesViewModel.ImportState.Loading).message,
            ...
            LazyColumn(
                ...
                itemsIndexed(profiles, key = { _, profile -> profile.id }) { index, profile ->
                    ...
                    ProfileCard(
                        ...
                        onEdit = {
                            if (profile.type == com.kunbox.singbox.model.ProfileType.Subscription ||
                                profile.type == com.kunbox.singbox.model.ProfileType.Imported) {
