...
import com.kunbox.singbox.viewmodel.NodesViewModel
import com.kunbox.singbox.ui.components.AddNodeDialog
import com.kunbox.singbox.ui.components.AddNodeTarget
import com.kunbox.singbox.ui.components.ConfirmDialog
import com.kunbox.singbox.ui.components.InputDialog
import com.kunbox.singbox.ui.components.NodeFilterDialog
import com.kunbox.singbox.ui.components.SingleSelectDialog
import com.kunbox.singbox.ui.components.NodeCard
...
fun NodesScreen(
    ...
    var pendingDeleteNode by remember { mutableStateOf<com.kunbox.singbox.model.NodeUi?>(null) }
    ...
    if (pendingDeleteNode != null) {
        val node = pendingDeleteNode!!
        ConfirmDialog(
            title = stringResource(R.string.common_delete),
            message = stringResource(R.string.nodes_delete_confirm, node.displayName),
            ...
            Box(modifier = Modifier.fillMaxSize()) {
                LazyColumn(
                    ...
                    itemsIndexed(
                        ...
                        val onDelete = remember(node.id, node.displayName) {
