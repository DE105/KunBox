...
private fun resolveOutboundText(
    ...
    value: String?,
    nodes: List<com.kunbox.singbox.model.NodeUi>,
...
private fun DomainRuleEditorDialog(
    ...
    nodes: List<com.kunbox.singbox.model.NodeUi>,
    nodesForSelection: List<com.kunbox.singbox.model.NodeUi>? = null,
    profiles: List<com.kunbox.singbox.model.ProfileUi>,
    onDismiss: () -> Unit,
    ...
    fun resolveNodeByStoredValue(value: String?): com.kunbox.singbox.model.NodeUi? {
