...
object AppUpdateChecker {
    ...
    private fun tryProxyRequest(request: Request, settings: com.kunbox.singbox.model.AppSettings): GitHubRelease? {
    ...
    private fun getProxyClient(settings: com.kunbox.singbox.model.AppSettings): OkHttpClient? {
