...
class PlatformInterfaceImpl(
    ...
    interface Callbacks {
        ...
        fun getCurrentSettings(): com.kunbox.singbox.model.AppSettings?
    ...
    override fun startDefaultInterfaceMonitor(listener: InterfaceUpdateListener?) {
        ...
        var initialNetwork: Network? = com.kunbox.singbox.utils.DefaultNetworkListener.underlyingNetwork
    ...
    override fun writeLog(message: String?) {
        ...
        com.kunbox.singbox.repository.LogRepository.getInstance().addLog(message)
    }
