...
import com.kunbox.singbox.utils.perf.DnsPrewarmer
import com.kunbox.singbox.utils.perf.PerfTracer
    ...
    private fun patchConfig(rawConfigContent: String, settings: AppSettings): String {
        ...
        try {
            ...
            val logConfig = configObj.log?.copy(level = logLevel)
                ?: com.kunbox.singbox.model.LogConfig(level = logLevel, timestamp = true, output = "box.log")
